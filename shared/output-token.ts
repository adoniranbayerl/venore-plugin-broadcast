// Token de saída = a parte da URL que o operador digita na TV (/ext/broadcast/out/<token>) —
// precisa ser curto e fácil de digitar num controle remoto, não um UUID. Gerado a partir do nome
// da saída
